...
(function () {
  ...
  function init(container) {
    ...
    const fileId = '1TDvZkNDaWYbvw8G-lExlq8buchBBUrRd';
    const modelPath = `https://drive.google.com/uc?export=download&id=${fileId}`;
    
    console.log('Buddy3D: Attempting to load GLB model from Google Drive...');
