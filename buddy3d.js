...
(function () {
  ...
  function init(container) {
    ...
    if (!THREE.GLTFLoader) {
      ...
      // Load from local file in your project
      const modelPath = 'buddy-model.glb'; // Put your GLB file in project root with this name
      
      console.log('Buddy3D: Attempting to load GLB model from local file...');
